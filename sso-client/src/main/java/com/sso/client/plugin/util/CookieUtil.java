package com.sso.client.plugin.util;
...
public class CookieUtil {
    ...
    public static void addCookie(HttpServletResponse response, String name, String value, int time, String domain){
        Cookie cookie = new Cookie(name,value);//创建新cookie
        cookie.setMaxAge(time * 60);// 设置存在时间为5分钟
        ...
        if (null==cookies) {
            ...
            for(Cookie cookie : cookies){
                ...
                if(cookie.getName().equals(name)){
                    ...
                    cookie.setPath("/");
                    cookie.setMaxAge(time * 60);// 修改存活时间
